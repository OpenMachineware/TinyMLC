/**
 * CMSIS-NN accelerated element-wise multiply operator
 *
 * Wraps arm_elementwise_mul_s8 to match TinyMLC's tmlc_multiply_s8 interface.
                       ...
                       int8_t* output, int size)
{
    ...
    arm_elementwise_mul_s8(input1, input2,
                          offset, offset,
                          output,
                          offset, mult, shift,
                          -128, 127,
