#!/bin/bash
# ARM Pure C Release Build Script (no hardware acceleration)
...
CFLAGS="-march=$ARCH $FPU $MCU -nostdlib -ffreestanding"
CFLAGS="$CFLAGS -fno-omit-frame-pointer -fno-asynchronous-unwind-tables"
...
$CC $CFLAGS -T link_arm.ld \
    ...
    fc.o softmax.o conv2d.o depthwise_conv2d.o avg_pool2d.o max_pool2d.o \
    add.o multiply.o relu.o relu6.o global_avg_pool.o \
...
$CC -D__DO_LINK_ONLY__ -march=$ARCH $FPU $MCU -S model.c -o model.s 2>/dev/null || true
