#!/bin/bash
# Host Debug Build Script - for local testing on x86/x64/ARM64
# Uses native GCC/Clang, no QEMU needed
...
CFLAGS="-g -O0 -Wall -DTINYMLC_DEBUG -I./include -I./c -I."
...
# ========== Host-specific files ==========
$CC $CFLAGS -c host/debug_print.c -o debug_print.o
$CC $CFLAGS -c model.c -o model.o
$CC $CFLAGS -c host/main_test.c -o main_test.o
...
$CC \
    ...
    $LSTM_OBJ \
    debug_print.o model.o main_test.o \
    -o model -lm
