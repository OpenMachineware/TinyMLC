 ...
 *
 * Note: NMSIS-NN LSTM API is complex with separate gate parameters.
...
// Pure C LSTM implementation (always used - NMSIS LSTM API is too complex)
    ...
    int hidden_size)
{
    ...
    // NMSIS-NN LSTM API requires complex gate parameter setup
