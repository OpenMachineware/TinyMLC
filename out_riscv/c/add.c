/**
 * NMSIS-NN accelerated element-wise addition operator
 *
 * Wraps riscv_elementwise_add_s8 to match TinyMLC's tmlc_add_s8 interface.
                 ...
                 int8_t* output, int size)
{
    ...
    riscv_elementwise_add_s8(input1, input2,
